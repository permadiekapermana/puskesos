  ...
  <div class='col-md-6'>
    <div class='box-body'>
      ...
      <label for='id_level'>Level</label> <br>                   
          ...
          <input type='radio' class='flat' name='level' id='level' value='puskesos' /> Petugas Puskesos
      </div>
  ...
  <div class='col-md-6'>
    <div class='box-body'>
      ...
      <label for='level'>Level</label> <br>";
        ...
        elseif ($r[level]=='puskesos')    {
          echo"
            <input type='radio' class='flat' name='level' id='level' value='admin' required /> Admin
            <input type='radio' class='flat' name='level' id='level' value='puskesos' checked='' /> Petugas Puskesos"; 
        }
        echo"
      </div>
      <div class='form-group'>
