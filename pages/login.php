...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>KEMLAKA</b>GEDE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <div class="form-group" align="center">
    <img class="login-box-msg" width="45%" src="images/logo-desa.png" alt="">
    ...
    <a href="../landing-page/index.html" class="text-center">Kembali ke Beranda</a> <br><br>
